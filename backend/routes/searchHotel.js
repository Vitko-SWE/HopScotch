...
router.route("/selectHotel").post((req, res) => {
    ...
    var query_string = `INSERT INTO TripFeatures VALUES ("${req.body.FeatureId}", "${req.body.FeatureType}", 0, "${req.body.Address}", "${req.body.StartDateTime}", "${req.body.EndDateTime}", "${req.body.BookingUrl}", ${req.body.TripId}, "${req.body.FeatureName}", null, false)`;
