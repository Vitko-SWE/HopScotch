...
export default function EditTrip(props) {
  ...
  const updateTripInfo = () => {
    getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
      axios.get(`/trips/gettrip/${props.match.params.tripid}`, {
        headers: {
  ...
  const updateUserRole = () => {
    getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
      axios.get(`/trips/getuserrole/${props.match.params.tripid}/${user.sub}`, {
        headers: {
          Authorization: `Bearer ${res}`,
        },
      }).then((res) => {
  ...
  const updateTripUsers = () => {
    getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
      axios.get(`/trips/gettripusers/${props.match.params.tripid}/all`, {
        headers: {
          Authorization: `Bearer ${res}`,
        },
      }).then((res) => {
  ...
  const updateTripOwners = () => {
    getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
      axios.get(`/trips/gettripusers/${props.match.params.tripid}/Owner`, {
        headers: {
          Authorization: `Bearer ${res}`,
        },
      }).then((res) => {
  ...
  const updateTripEditors = () => {
    getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
      axios.get(`/trips/gettripusers/${props.match.params.tripid}/Editor`, {
        headers: {
          Authorization: `Bearer ${res}`,
        },
      }).then((res) => {
  ...
  const updateTripViewers = () => {
    getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
      axios.get(`/trips/gettripusers/${props.match.params.tripid}/Viewer`, {
        headers: {
          Authorization: `Bearer ${res}`,
        },
      }).then((res) => {
  ...
  const handleAddOwners = (e) => {
    ...
    if (errors !== "") {
      ...
      getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
        axios.post(`/trips/addtripusers/${props.match.params.tripid}/Owner`, {
          users: emails,
        }, {
          headers: {
            Authorization: `Bearer ${res}`,
  ...
  const handleAddEditors = (e) => {
    ...
    if (errors !== "") {
      ...
      getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
        axios.post(`/trips/addtripusers/${props.match.params.tripid}/Editor`, {
          users: emails,
        }, {
          headers: {
            Authorization: `Bearer ${res}`,
  ...
  const handleAddViewers = (e) => {
    ...
    if (errors !== "") {
      ...
      getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
        axios.post(`/trips/addtripusers/${props.match.params.tripid}/Viewer`, {
          users: emails,
        }, {
          headers: {
            Authorization: `Bearer ${res}`,
  ...
  const handleEditUsers = (e) => {
    ...
    if (results.roleSelectUser.value === user.sub && userRole === "Owner" && results.roleSelectRole.value !== "Owner" && tripOwners.length === 1) {
      ...
      if (results.roleSelectRole.value !== "Remove user from trip") {
        getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
          axios.post(`/trips/edituserrole/${props.match.params.tripid}/${results.roleSelectUser.value}`, {
        ...
        getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
          axios.delete(`/trips/removeuser/${props.match.params.tripid}/${results.roleSelectUser.value}`, {
            headers: {
              Authorization: `Bearer ${res}`,
            },
          }).then((res) => {
  ...
  const handleEditDetails = (e) => {
    ...
    if (errors !== "") {
      ...
      getAccessTokenSilently({audience: "https://hopscotch/api"}).then((res) => {
        axios.post(`/trips/updatetrip/${props.match.params.tripid}`, {
  ...
  const deleteTrip = (e) => {
    e.preventDefault();
    getAccessTokenSilently({ audience: "https://hopscotch/api" }).then((res) => {
      axios.delete(`/trips/deletetrip/${props.match.params.tripid}/`, {
        headers: {
          Authorization: `Bearer ${res}`,
        },
      }).then((res) => {
