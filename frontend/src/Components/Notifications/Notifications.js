...
import { Dropdown, Toast, Badge, Alert, Button } from 'react-bootstrap';
            ...
            <Badge pill variant="dark">
              <Dropdown data-testid="dropdown" drop="left" >
                ...
                {displayNotification ? notification.map((item, index) => (
                  ...
                  // </Toast>
                  <Alert  variant="info" dismissible onClose={() => handleToastClose(index)}>
                    <Alert.Heading>{item.NotificationTitle}</Alert.Heading>
